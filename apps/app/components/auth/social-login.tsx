...
export function SocialLogin({ onError, isDisabled }: SocialLoginProps) {
  const handleGoogleLogin = async () => {
    try {
      ...
      const returnUrl = currentPath !== "/login" ? currentPath : authConfig.oauth.postLoginRedirect;
  ...
  return (
    <Button type="button" variant="outline" className="w-full" onClick={handleGoogleLogin} disabled={isDisabled}>
