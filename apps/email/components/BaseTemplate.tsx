...
export function BaseTemplate({ preview, children, appName = "React Starter Kit", appUrl = "https://example.com" }: BaseTemplateProps) {
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={header}>
            <Img src={logoDataUri} width="40" height="40" alt={appName} style={logo} />
          ...
          <Section style={footer}>
            <Text style={footerText}>This email was sent by {appName}. If you didn't expect this email, you can safely ignore it.</Text>
