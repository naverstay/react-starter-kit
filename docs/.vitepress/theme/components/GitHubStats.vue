<template>
  <div class="github-stats">
    <a href="https://github.com/kriasoft/react-starter-kit/stargazers" class="stat-item">
      <svg class="stat-icon" aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16">
        <path
    ...
    <a href="https://github.com/kriasoft/react-starter-kit/forks" class="stat-item">
      <svg class="stat-icon" aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16">
        <path
